                            ...
                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        ...
                                        <img src="{{ URL::asset('../Backend/images/User/'.Auth::user()->photo) }}"
                        ...
                        <ul class="nav nav-pills user-nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-order-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="false"><i data-feather="shopping-bag"></i>Commandes</button>
                            </li>
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link"  onclick="location.href = '/logout' " id="pills-out-tab" data-bs-toggle="pill" data-bs-target="#pills-out"
                                 type="button" role="tab" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel"
                                ...
                                <div class="dashboard-home">
                                    ...
                                    <div class="dashboard-user-name">
                                        <h6 class="text-content">Salut, <b class="text-title">{{ Auth::user()->prenom}} {{ Auth::user()->nom}}</b></h6>
                                        <p class="text-content">À partir de votre tableau de bord , vous avez
                                            la possibilité d'afficher une instance de l'activité récente de votre compte
                                             et de mettre à jour les informations de votre compte. Sélectionnez un lien ci-dessous
                                             pour afficher ou modifier les informations.</p>
                                    </div>
                            ...
                            <div class="tab-pane fade show" id="pills-wishlist" role="tabpanel"
                                ...
                                <div class="dashboard-wishlist">
                                    ...
                                    <livewire:frontend.dashboard-user.favoris />
                                </div>
                            </div>
                                ...
                                <div class="dashboard-order">
                                    ...
                                    <div class="order-contain">
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="../Frontend/assets/images/vegetable/product/2.png" alt=""
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="product-left-thumbnail.html" class="order-image">
                                                    <img src="../Frontend/assets/images/vegetable/product/3.png" alt=""
                                                        class="blur-up lazyload">
                                                </a>
                          ...
                          <livewire:frontend.dashboard-user.editprofile />
